...
<div class="tabsAction">
	[onshow;block=begin;when [user.rights.coconut.write;noerr]=1]
	
		[onshow;block=begin;when [object.status]=[Tcoconut.STATUS_DRAFT]]
		...
		[onshow;block=begin;when [object.status]=[Tcoconut.STATUS_VALIDATED]]
		...
		<!-- '-+' est l'équivalent d'un signe '<' (TBS oblige) -->
		[onshow;block=begin;when [object.status]-+[Tcoconut.STATUS_REFUSED]]
