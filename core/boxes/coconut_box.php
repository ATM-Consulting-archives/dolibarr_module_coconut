 ...
 */
class coconutbox extends ModeleBoxes
{

    public $boxcode = "mybox";
    public $boximg = "coconut@coconut";
    public $boxlabel;
    public $depends = array("coconut");
    public $db;
    public $param;
    ...
    public function loadBox($max = 5)
    {
        ...
        //include_once DOL_DOCUMENT_ROOT . "/coconut/class/coconut.class.php";
