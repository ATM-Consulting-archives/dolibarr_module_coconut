 ...
 */
class pdf_crabe_deposit_on_total_block extends ModelePDFFactures
{
    var $db;
    var $name;
    var $description;
	...
	function __construct($db)
	{
		...
		$this->db = $db;
		$this->name = "crabe_deposit_on_total_block";
		$this->description = $langs->trans('PDFCrabeDepositOnTotalBlockDescription');
	...
	{
		global $conf,$mysoc;
		$outputlangs->load('coconut@coconut');
		$sign=1;
        if ($object->type == 2 && ! empty($conf->global->INVOICE_POSITIVE_CREDIT_NOTE)) $sign=-1;
